        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <motion.div
              ...
              animate="visible"
              exit="exit"
              className={`relative w-full ${sizeClasses[size]} bg-white dark:bg-dark-bg-secondary rounded-xl shadow-strong border border-slate-200 dark:border-slate-700 ${className}`}
            >
              {/* Header */}
